...
# Use DATABASE_URL from the environment. This keeps deployment credentials out
# of source control and supports SQLite for local development.
...
try:
    ...
    print("  2. Open the configured ServerMonitor URL")
    print()
