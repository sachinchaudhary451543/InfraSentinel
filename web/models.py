...
class AzureDeviceOwner(db.Model):
    ...
    # References
    device_id = db.Column(db.String(255), db.ForeignKey('azure_device.device_id'), nullable=False)
    user_id = db.Column(db.String(255), db.ForeignKey('azure_user.user_id'), nullable=False)
