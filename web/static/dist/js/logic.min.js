...
function renderSummary(summary, types) {
  let html = `<h2 class="text-xl font-bold mb-3">≡ƒôÿ Summary</h2>
...
fileInput.addEventListener("change", async (e) => {
  ...
  if (!file) return;
  statusEl.textContent = "≡ƒôñ Uploading and analyzing data...";
  ...
  if (result.error) {
    statusEl.textContent = `Γ¥î Error: ${result.error}`;
    return;
  }
  statusEl.textContent = "Γ£à Analysis complete!";
  datasetId = result.id;
