...
function colorClass(v) {
  const n = Number(v);
  if (!isFinite(n)) return "text-gray-600";
...
async function updateBarChartAcrossServers(hours) {
  try {
    ...
    const labels = Object.keys(serverMap).slice(0, 10);
...
function renderCards(data) {
  ...
  const cards = [
    {
      title: "Server",
      value: latest.Hostname || "ΓÇö",
      color: "blue",
      size: "col-span-1",
    },
    {
      title: "CPU (Latest)",
      value: latest.CPU != null ? latest.CPU + "%" : "ΓÇö",
      color: "red",
      size: "col-span-1",
    ...
    {
      title: "RAM (Latest)",
      value: latest.RAM != null ? latest.RAM + "%" : "ΓÇö",
      color: "green",
      size: "col-span-1",
    ...
    {
      title: "SSD (Latest)",
      value: latest.SSD != null ? latest.SSD + "%" : "ΓÇö",
      color: "yellow",
      size: "col-span-1",
...
function renderAll(mapped) {
  if (!Array.isArray(mapped) || mapped.length === 0) {
    document.getElementById("cards").innerHTML =
      '<div class="col-span-full text-center text-gray-500 p-8">≡ƒôè No data available for the selected filters.</div>';
  ...
  try {
    ...
    document.getElementById("cards").innerHTML =
      `<div class="col-span-full bg-red-50 border-l-4 border-red-500 p-4 rounded">
        <p class="text-red-700 font-semibold">ΓÜá∩╕Å Error loading dashboard</p>
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  E.themeToggle = document.getElementById("themeToggle");
